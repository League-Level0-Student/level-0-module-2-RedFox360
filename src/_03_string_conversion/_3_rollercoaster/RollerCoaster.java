...
public class RollerCoaster {
	...
	public static void main(String[] args) {
		...
		if (heightToInt >= 42) {
			System.out.println("You can ride the coaster with someone else");
		}
		if (heightToInt >= 48)	{
			System.out.println("Hurray! You can ride the coaster alone!");
		}
		else	{
			System.out.println("You must be at least 42 inces tall to ride the roller coaster, PAL");
		}
